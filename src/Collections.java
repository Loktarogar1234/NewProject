...
public class Collections {
    public static void main(String[] args) {
        ...
        (arraycopy) старые элементы - это тоже может быть затратно*/
        List<String> fruits1 = new ArrayList<>(); //Интерфейс ArrayList коллекции List
        fruits1.add("apple");
        ...
        /* Стек () реализцет принцип FILO (первый вошел - последний вышел). Примеры - лифт, полка книг)*/
